...
#define kBufSize 32768
#define kLineSze 1024
...
int main(int argc, char *argv[]) {
    ...
    char prev_buffer[kBufSize ];

    // clearing dummy data with 0.

    memset(buffer, 0x00, sizeof(buffer));
    memset(prev_buffer, 0x00, sizeof(prev_buffer));
