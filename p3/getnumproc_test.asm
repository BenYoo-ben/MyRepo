...
int main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	printf(2,"Total Number of Active Processes : %d\n",get_num_proc());
  11:	e8 1c 03 00 00       	call   332 <get_num_proc>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 80 07 00 00       	mov    $0x780,%ebx
        while(*s != 0){
 ...
 5d1:	a1 2c 0a 00 00       	mov    0xa2c,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 2c 0a 00 00       	mov    %eax,0xa2c
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 2c 0a 00 00 30 	movl   $0xa30,0xa2c
 727:	0a 00 00 
 72a:	c7 05 30 0a 00 00 30 	movl   $0xa30,0xa30
 731:	0a 00 00 
    base.s.size = 0;
 734:	b8 30 0a 00 00       	mov    $0xa30,%eax
 739:	c7 05 34 0a 00 00 00 	movl   $0x0,0xa34
 740:	00 00 00 
