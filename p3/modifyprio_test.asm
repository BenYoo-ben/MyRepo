...
_modifyprio_test:     file format elf32-i386
...
int main(void)
{
  ...
  18:	75 48                	jne    62 <main+0x62>
	  {
		  set_prio(1000);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	68 e8 03 00 00       	push   $0x3e8
  22:	e8 63 03 00 00       	call   38a <set_prio>
		  printf(2,"Original priority : %d\n",get_prio());
  27:	e8 66 03 00 00       	call   392 <get_prio>
  ...
  37:	e8 04 04 00 00       	call   440 <printf>
		  set_prio(75);
  3c:	c7 04 24 4b 00 00 00 	movl   $0x4b,(%esp)
  43:	e8 42 03 00 00       	call   38a <set_prio>
		  printf(2,"Change priority to 75, result : %d\n",get_prio());
  48:	e8 45 03 00 00       	call   392 <get_prio>
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	50                   	push   %eax
  51:	68 b0 07 00 00       	push   $0x7b0
  56:	6a 02                	push   $0x2
  ...
  5d:	e8 60 02 00 00       	call   2c2 <exit>
	  ...
	  {
		  wait();
  62:	e8 63 02 00 00       	call   2ca <wait>
		  exit();
