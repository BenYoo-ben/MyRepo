  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  9f:	83 c2 01             	add    $0x1,%edx
            set_prio(priority);
  a2:	52                   	push   %edx
  a3:	e8 82 04 00 00       	call   52a <set_prio>
            delay(5);
  a8:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  ...
  cc:	57                   	push   %edi
  cd:	57                   	push   %edi
  ce:	68 55 09 00 00       	push   $0x955
  d3:	6a 01                	push   $0x1
  d5:	e8 06 05 00 00       	call   5e0 <printf>
            exit();
