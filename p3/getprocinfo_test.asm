 ...
 611:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 a8 0a 00 00    	cmp    %eax,0xaa8
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 ...
 767:	0a 00 00 
 76a:	c7 05 ac 0a 00 00 ac 	movl   $0xaac,0xaac
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 ac 0a 00 00       	mov    $0xaac,%eax
 779:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 780:	00 00 00 
