...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 6a 07 00 00       	mov    $0x76a,%ebx
        while(*s != 0){
 ...
 5d1:	a1 18 0a 00 00       	mov    0xa18,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 18 0a 00 00       	mov    %eax,0xa18
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 18 0a 00 00    	mov    %edx,0xa18
}
 ...
 727:	0a 00 00 
 72a:	c7 05 1c 0a 00 00 1c 	movl   $0xa1c,0xa1c
 731:	0a 00 00 
    base.s.size = 0;
 734:	b8 1c 0a 00 00       	mov    $0xa1c,%eax
 739:	c7 05 20 0a 00 00 00 	movl   $0x0,0xa20
 740:	00 00 00 
